...
using TCC.WebService.Exceptions;

namespace TCC.WebService.Features.Comum
{
    public class ApiControlleBase : ApiController
    {
        ...
        protected IHttpActionResult HandleFailure<T>(T exceptionToHandle) where T : Exception
        {
            ...
            return exceptionToHandle is DomainException ?
