...
export abstract class AbstractResolveService<T> implements Resolve<boolean> {
    ...
    */
     ...
     *
     * Esse método vai obter os dados da entidade que está com o identificador nas rotas
     * usando o resolveFromRoute() (veja mais nesse método)
